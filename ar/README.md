...
يخزّن هذا المستودع كل وثيقة تشغيلية تُدير الشركة: الاستراتيجية والأهداف والنتائج الرئيسية (OKRs)، وقواعد الحوكمة، والعقود القانونية، والسياسات المالية، وحزم الامتثال السعودية (PDPL وZATCA وMISA ونطاقات)، وأطر الموارد البشرية، وأدلّة النفاذ إلى السوق، ومواد المستثمرين، وأصول العلامة التجارية، ومواصفات المنتج والهندسة.

**ولا يحتوي على أي شيفرة مصدرية للتطبيق** — فبرمجيات منتج فلاي قاكا تقيم في مستودعات مستقلّة مخصّصة:

| المستودع | الدور والوصف |
| --- | --- |
| **ay2m/Office** (هذا المستودع) | نظام تشغيل الأعمال — الاستراتيجية والحوكمة والشؤون القانونية والمالية والامتثال السعودي والموارد البشرية والنفاذ إلى السوق |
| [ay2m/FlyGACA](https://github.com/ay2m/FlyGACA) | flygaca.com — تطبيق الويب التقدّمي (PWA) ثنائي اللغة المبني على React 19 + Vite **و**خلفيّته المبنية على Express والعاملة على Cloud Run (`me-central2`، وCloud SQL، وMoyasar)، إضافةً إلى المصنّف التنظيمي وخطوط إنتاج المحتوى |
| [ay2m/Captain-Adel](https://github.com/ay2m/Captain-Adel) | خدمة مدرّب الطيران بالذكاء الاصطناعي (captadel.com) + محرّك RAG خلف المحادثة واستدعاء الدوال والتقييمات |
...
| [`04`](04-compliance-ksa/) | **الامتثال (السعودية)** | رخصة الاستثمار من MISA، وحزمة الفوترة الإلكترونية لدى ZATCA، وبرنامج الامتثال وتقييم أثر حماية البيانات (PDPL)، وخطة نطاقات، وخطط استمرارية الأعمال والتعافي من الكوارث |
...
| [`07`](07-gtm/) | **النفاذ إلى السوق** | أدلّة المبيعات، ونصوص العروض التوضيحية، ومعالجة الاعتراضات، وقوالب التواصل البارد، ومسار صفقات B2B، واستراتيجية تحسين محركات البحث واستكشاف الكلمات المفتاحية |
...
| 🌍 **ثنائية اللغة أصالةً (EN / AR)** | نسخة عربية (فصحى بالاصطلاح السعودي) موازية تحت `ar/`؛ وتبقى أسماء الملفات ASCII بنمط kebab-case متطابقة لتسهيل المقارنة. |
| 📋 **بيانات وصفية YAML** | حقول موحّدة `title / section / doc_type / status / owner / last_updated / lang` على كل وثيقة. |
| 🔒 **منظومة الامتثال السعودية** | مبنية خصّيصًا للأطر النظامية السعودية: PDPL، والفوترة الإلكترونية لدى ZATCA، وترخيص MISA، ونطاقات. |
...
- 118 ملف `.md` تُحفظ متزامنة مع المصدر الإنجليزي
