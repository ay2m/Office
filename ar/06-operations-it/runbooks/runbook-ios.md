...
> الأصلية** — تطبيق SwiftUI واحد يعمل دون اتصال لكل وحدة دراسية (**ELPT وAIP**؛
> أما وحدات اختبارات الرخص PPL وCPL وIR وATPL فمعلّقة منذ 2026-08-10 وأُزيلت
> أهدافها)، بدفع مسبق لمرة واحدة، يُبنى من المستودع المشترك
...
2. **البناء / الاختبار / CI** — في مستودع العائلة: `docs/RUNBOOK-ios-release.md`
   ...
   لكل تطبيق، ومسار TestFlight يتفعّل متى وُجدت أسرار التوقيع.
3. **بوابة Apple (عمل بشري لمرة واحدة)** — `docs/RUNBOOK-ios-signing.md` +
   `docs/RUNBOOK-ios-signing-CHECKLIST.md`: مجموعة التطبيقات
   `group.com.flygaca.study`؛ معرّفات التطبيقات (أُزيل تسجيل الدخول عبر Apple من
   ملف الاستحقاقات المشترك في أغسطس 2026، فلا حاجة إلى تجميع الصلاحية؛ وإن عاد
   فالمعرّف الأساسي هو `com.flygaca.elpt`)؛ شهادة التوزيع؛ ملفات التزويد
