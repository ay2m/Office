...
#### Markdown
- Follow the existing *Fly GACA Document Style Guide* (see `fly-gaca-document-style-guide.md`) as the baseline.  
...
- **Existing Markdown Guide**: `/Users/flygaca/Documents/Fly GACA /The Office/11-brand/fly-gaca-document-style-guide.md`  
