...
> This is a **template skeleton**, not legal or regulatory advice and not a statement of
> current compliance status. Every registration status, deadline, and obligation below must
> be confirmed by the owner against the authoritative deliverables and the relevant Saudi
> authority before it is relied upon. Do not treat unfilled prompts as facts.
...
`.docx` deliverables listed below.
