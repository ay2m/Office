...
- Engine: `iflygaca/FlyGACA/server/src/zatca-core.ts`
- Automated Verification: `iflygaca/FlyGACA/server/tests/zatca-core.test.ts` (4 unit tests verifying TLV encoding, SHA-256 digest, UBL 2.1 generation, and Academy B2B billing).
- Tax Invoice Template: `iflygaca/Office/03-finance/tax-invoice-template.html`
