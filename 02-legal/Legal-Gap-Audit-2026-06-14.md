...
| L-05 | `Confidentiality & Non-Compete Agreement.docx` | Staff confidentiality + non-compete | Internal/HR use |
...
| # | File | What it covers |
|---|------|---------------|
| C-01 | `PDPL Compliance Program & DPIA.docx` | Full PDPL framework: lawful bases, data inventory, rights process, cross-border rules, sub-processor register, DPIA for Captain Adel AI — internal compliance doc |
| C-02 | `Sub-Processor List & DPA Register.docx` | Sub-processor DPA register (Google Cloud, Moyasar, future analytics) |
...
| C-08 | `Saudi Tax & Compliance Calendar.docx` | VAT/Zakat deadlines |
| C-09 | `Saudization Nitaqat Compliance Plan.docx` | Saudization planning |
| C-10 | `Tamheer & Doroob Program Application Pack.docx` | Graduate training programmes |
...
| Document | Status | Priority | Risk if missing |
|----------|--------|----------|----------------|
| **PDPL DPIA** (Data Protection Impact Assessment) | Exists in `04-compliance-ksa/PDPL Compliance Program & DPIA.docx` — covers Captain Adel AI data flows, risk register, mitigation, sign-off | Named launch blocker in Review-Action-Plan §7 — status: internally signed by founder-as-DPO but **not yet reviewed by SDAIA-qualified counsel** | Without completed DPIA, regulator could deem AI processing unlawful; SDAIA enforcement risk |
...
| **Sub-Processor / DPA Register** | Exists in `04-compliance-ksa/Sub-Processor List & DPA Register.docx` — covers Google Cloud, Moyasar; future analytics TBD | **P1** — register is internal only; public Privacy Notice must reference sub-processors or link to sub-processor list | PDPL transparency gap |
