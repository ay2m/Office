---
title: Fly GACA — B2B Order Form (Template)
section: 02-legal
doc_type: legal
status: draft
owner: Founder
...
## ORDER FORM No. [FG-OF-YYYY-NNN]

**Order Date:** [YYYY-MM-DD]
**Quote Reference:** [Quote no. — quotes are valid 30 days from issue]
...
This Order Form is governed by, and incorporates, the following (in order of precedence for their subject matter):

| Document | Reference | Applies |
|---|---|---|
| Customer Agreement & EULA | `customer-agreement-eula.docx` (02-legal/) | ☐ Yes — commercial terms, licence, liability |
| B2B Data Processing Agreement (DPA) | `b2b-data-processing-agreement-draft-2026-06-14.md` | ☐ Yes — **must be signed before cadet data processing begins** (PDPL) |
| Service Level Agreement (SLA) | `service-level-agreement-sla.docx` (02-legal/) | ☐ Yes |
| 60-Day Pilot Agreement | `60-day-pilot-agreement.docx` (02-legal/) | ☐ Only if this order converts a pilot |
| Refund & Cancellation Policy | `refund-and-cancellation-policy-draft-2026-07-03.md` §6 | ☐ Yes — B2B defaults |

In case of conflict: this Order Form prevails on commercial specifics (seats, fees, term); the DPA prevails on data protection; the Customer Agreement & EULA prevails otherwise.

### 6. General

- **Governing law:** Kingdom of Saudi Arabia.
- **Independence notice:** Fly GACA is an independent educational platform and is not affiliated with, endorsed by, or connected to the General Authority of Civil Aviation (GACA). Seats provide exam preparation and study tooling only; official GACA and testing fees are excluded.
- **Entire order:** This Order Form plus the Governing Documents constitute the entire agreement for this order. Amendments require written agreement by both parties.

### 7. Signatures

**Customer:** [Academy / school legal name]
