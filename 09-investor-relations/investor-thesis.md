...
> This is a **template skeleton**, not a finalized investment narrative or any commitment of
> figures. Fill from the pitch deck and supporting deliverables; confirm every number against
> finance before sharing externally. Unfilled prompts are not facts.
...
## 2. Problem & market
> TODO(owner): Regulatory-fragmentation pain and TAM. The Improvement Audit characterizes the
> product fit as "painkiller (regulatory fragmentation)" — expand with sourced market data.
...
> traction metrics. Reconcile all figures with `../03-finance/`.
