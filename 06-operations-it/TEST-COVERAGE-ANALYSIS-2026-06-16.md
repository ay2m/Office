...
> described in the `SPEC-*.md` files, `captadel-plan.md`, and `TEST_READY.md`
...
|---|---|---|---|
| **Sales-agent E2E** (Enrollment / CFI / B2B) | `TEST_READY.md` | 55 cases (≥ 38 min) | `python3 sales_agents/tests/test_runner.py` |
...
- **No reconciliation between the two suites.** `TEST_READY.md` (55 cases, "≥38") and the
