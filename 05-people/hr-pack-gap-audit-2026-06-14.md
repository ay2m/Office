...
> This gap audit and all linked template recommendations require review by a qualified Saudi HR professional and/or Saudi-licensed legal counsel before any documents are finalised or acted upon. Saudi Labor Law (Royal Decree M/51 and its amendments) is the governing framework. Nothing here constitutes legal advice.
...
|---|------|----------------|--------------------------|
| 1 | Employee Handbook | Mission/values, employment basics, probation (90/180 days), working hours, Ramadan hours, remote/hybrid policy, public holidays, leave summary, expense cross-ref, InfoSec basics, IP assignment, confidentiality, communication norms, termination/notice (60 days), EOSB formula, exit checklist stub, open-door policy | Leave entitlements referenced but not detailed as standalone policy; grievance/disciplinary procedure absent; anti-harassment absent; attendance rules absent |
| 2 | Saudi-Compliant Employment Contract Template | Parties, position, probation, salary structure (basic/housing/transport split), WPS/GOSI, salary review, IP assignment schedule | Solid template; no offer letter precursor; no explicit Nitaqat nationality field |
| 3 | Compensation Philosophy | Four IC bands (SAR), equity/phantom equity structure, GOSI/WPS breakdown, benefits summary, review cadence | Excellent; no mention of Tamheer trainee stipend positioning |
| 4 | Job Descriptions Pack | Six role JDs: Sr SWE Full-Stack, ML/AI Eng., Head of Product, Head of CS, Marketing Lead, COO | Covers near-term hiring plan; no JDs for interns/Tamheer trainees |
| 5 | Performance Review Template | Self-assessment, manager assessment, competency rubric (1–5), 360 summary, SMART goals, compensation discussion, PIP trigger | Good; no PIP template itself; no formal probation review form |
| 6 | 30-60-90 Day New Hire Plan Template | Days 1/1-3/Week 1/Week 2/Week 3/Week 4, 31-60 contribute phase, 61-90 lead phase, check-in cadence | Serves as partial onboarding checklist; no IT provisioning checklist; no formal offboarding equivalent |
| 7 | 1-on-1 Meeting Template | Weekly agenda, parking lot, mood check, goal tracking | Present and functional |
| 8 | Daily Standup Template | 3-question async format, blockers | Present and functional |
| 9 | Monthly All-Hands Template | Agenda, metrics, wins, roadmap, open Q&A | Present and functional |
| 10 | Founder Calendar & Time Audit Template | Weekly time-blocking, audit scoring | Operational tool; not a people policy |
| 11 | Social Media Policy | Employee social media conduct, Captain Adel persona rules, content approval workflow | Covers external posting; no influencer/ambassador distinction |

---

## 2. Documents Present in 04-compliance-ksa/ (relevant overlap)

| File | HR-Relevant Content | Overlap Risk |
|------|---------------------|--------------|
| Saudization Nitaqat Compliance Plan | Nitaqat band targets, Saudi/expat ratio, Mudad reporting, penalty avoidance | **Must not duplicate** — Leave & PTO Policy should cross-reference Nitaqat's Saudi-only annual leave entitlements |
| Tamheer & Doroob Program Application Pack | Tamheer trainee onboarding, 12-month programme, HRDF subsidy | Onboarding Checklist must have a separate Tamheer track — do not merge with regular employee onboarding |

---

## 3. Gap Matrix — Missing Standard Documents

Priority key: **P1** = critical / legally required or high legal risk | **P2** = strongly recommended for an early-stage team | **P3** = best practice, implement by Series A
...
8. Attendance Policy — P2
9. Remote/Hybrid Work Agreement (per-employee annex) — P2
10. Training & Development Policy — P2
11. PIP Template — P2
...
## 5. Bilingual Coverage Note

Current 05-people documents are English-primary. For Saudi national employees (Saudization compliance), Arabic versions of the employment contract, grievance procedure, disciplinary notices, and termination letters are strongly recommended and may be required by HRSD in any dispute. The two templates drafted in this pack (Offer Letter and Leave & PTO Policy) are bilingual-structured with EN primary and AR section headers.

---

*Cross-references: 04-compliance-ksa/saudization-nitaqat-compliance-plan.docx | 04-compliance-ksa/tamheer-and-doroob-program-application-pack.docx | 05-people/employee-handbook.docx | 05-people/saudi-compliant-employment-contract-template.docx*
