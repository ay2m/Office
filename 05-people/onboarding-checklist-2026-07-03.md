---
title: Fly GACA — New Hire Onboarding Checklist
section: 05-people
doc_type: checklist
status: draft
owner: Founder / HR
...
**Owner key:** F = Founder (acting HR/IT) | NH = New Hire | Mgr = Line manager (Founder until team grows).

---

## 2. Phase A — Pre-Start (Day -7 to Day -1)

| ☐ | Task | Owner | Done-when |
|---|------|-------|-----------|
| ☐ | Signed offer letter on file (05-people/offer-letter-template-2026-06-14.md) | F | Countersigned copy saved to employee HR folder in Drive |
...
| ☐ | Task | Owner | Done-when |
|---|------|-------|-----------|
| ☐ | Verify original ID/Iqama in person (or certified remote process) | F | Sighted-original note added to HR file |
| ☐ | Sign full Day 1 pack (contract, IP assignment, NDA, handbook + remote-work acknowledgments) | NH + F | All executed copies in Drive HR folder; employee has copies |
| ☐ | Employee authenticates contract in Qiwa | NH | Qiwa status = authenticated |
...
| ☐ | End-of-week check-in (1-on-1 template, 05-people/1-on-1-meeting-template.docx) | Mgr | Notes filed; blockers assigned |

---

## 5. Phase D — Days 8–30 (Learn)

| ☐ | Task | Owner | Done-when |
|---|------|-------|-----------|
| ☐ | Weekly 1-on-1s held; probation expectations restated in writing | Mgr | Four 1-on-1 notes on file |
| ☐ | Compliance sweep: GOSI active, first WPS salary paid on time via Mudad, Qiwa contract authenticated | F | All three verified after first payroll |
| ☐ | Access review: remove any over-provisioned access from Week 1 | F | Access list matches role needs |
| ☐ | Day 30 probation checkpoint: on/off track, documented feedback | Mgr | Written checkpoint note shared with employee |

---

## 6. Phase E — Days 31–60 (Contribute)

| ☐ | Task | Owner | Done-when |
|---|------|-------|-----------|
| ☐ | 30-60-90 plan "contribute" goals in progress; blockers escalated | NH + Mgr | Mid-point review note filed |
| ☐ | Day 60 probation checkpoint; if concerns exist, state them in writing with improvement expectations | Mgr | Checkpoint note acknowledged by employee |
| ☐ | Confirm leave accrual is being tracked from Day 1 (Leave & PTO Policy §3.2) | F | Leave tracker row correct |

---

## 7. Phase F — Days 61–90 (Lead / Probation Decision)
...
| ☐ | Day 90 retro: capture onboarding improvements into this checklist | F | Checklist updated, `last_updated` bumped |
